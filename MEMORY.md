...
- Status: Phase 1 platform extraction is implemented on `windows-port/phases-1-4`; GitHub Actions is active and the first macOS CI run exposed two focused regressions that are fixed locally pending an exact-commit rerun. Phase 2–4 have not started.
